...
<body>
	...
	<section id="home" class="home" style="background-image: url(img/bgmain.jfif)">
		...
		<div class="content2"><img src="img/fotoku.png" class="img" /></div>
	</section>
	<!-- akhir  home -->
	...
	<!-- awal project -->
	<section id="project" class="project" style="background-image: url(img/bgmain2.jfif)">
		<div class="title">
		...
		<div class="content">
			<div class="card">
				<div class="img-card"><a href="https://github.com/aefafifah/Tubes-PBO" target="blank" /><img 
					src="img/project/pbo.jfif" /></a>
				</div>
			</div>
			<div class="card">
				<div class="img-card"><a href="d:\semester3\tubes\jarkom\tubes  jarkom topologi.pkt" target="blank" /><img
						src="img/project/jaringan.jfif" /></a></div>
			</div>
			<div class="card">
				<div class="img-card"><a href="d:\semester3\tubes\PCD\Tubes PCD\code tilt_shift_on_faces.ipynb" target="blank" /><img
						src="img/project/citra digital.jfif" /></a></div>
			</div>
